function fetchHelloDataFromAPI() {
    fetch('http://localhost:3003/test/helloclient', {
        method: 'GET',
        headers: new Headers({
...
function postToOne() {
    var url = 'http://localhost:3003/test/one';
...
function postData() {
    ...
    fetch('http://localhost:3003/test/seven', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function fetchFromOneDisplayData() {
    let url = 'http://localhost:3003/test/one';
